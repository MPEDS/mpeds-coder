...
var inputFieldTemplate = function (type) {
  return {
    'template': '<input type="' + type + '" ' +
        'class="form-control"' +
      '<%= (fieldHtmlClass ? "class=\'" + fieldHtmlClass + " form-control \' " : "form-control") %>' +
...
jsonform.elementTypes = {
  ...
  'highlightlist': {
    ...
    'onInsert': function(evt, node) {
        ...
        var createListItem = function(e, v, p_id, text) {
          ...
          // create element
          var li = "<p id='" + p_id + "'>" + displayText + " <a id='" + hash + "' class='glyphicon glyphicon-remove fa fa-remove'></a></p>";
  ...
  'select':{
    'template':'<select name="<%= node.name %>" id="<%= id %>" class="form-control"' + 
      '<%= (fieldHtmlClass ? " class=\'" + fieldHtmlClass + "\'" : "") %>' +
      '<%= (node.disabled? " disabled" : "")%>' +
      '<%= (node.schemaElement && node.schemaElement.required ? " required=\'required\'" : "") %>' +
      '> ' +
